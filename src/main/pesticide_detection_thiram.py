...
from src.config.config_pesticide_detection_thiram import (INSTALLATION_NEEDED, INTENSITY_MAP_COLORS, DIGITAL_MAP_COLORS,
...
if __name__ == "__main__":
    ...
    norm = NonlinearNorm(vmin=0, vmax=2500)
